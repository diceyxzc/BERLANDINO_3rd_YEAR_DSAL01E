...
{
    internal class DB_Payroll_Functions
    {
        // Convert basic pay input fields
        public void Basic_Convert_Textboxes(TextBox basic_rate_txtbox, TextBox basic_numhrs_txtbox, Price_Variables vars)
        {
        ...
        public void Hono_Convert_Textboxes(TextBox hono_numhrs_txtbox, TextBox hono_rate_txtbox, Price_Variables vars)
        {
        ...
        public void Other_Convert_Textboxes(TextBox other_numhrs_txtbox, TextBox other_rate_txtbox, Price_Variables vars)
        {
        ...
        public void Converting_Compute_Textboxes(
            ...
            TextBox FS_loan_txtbox, TextBox FSD_loan_txtbox, TextBox other_loan_txtbox, Price_Variables vars)
        {
        ...
        public void Compute_Total_And_Net(Price_Variables vars)
        {
