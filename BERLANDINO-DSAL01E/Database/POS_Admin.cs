...
namespace BERLANDINO_DSAL01E.Database
{
    public partial class POS_Admin : Form
    {
        ...
        private void clear_textboes()
        {
            try
            {
                pic = Image.FromFile("C:\\Users\\fla10\\source\\repos\\diceyxzc\\BERLANDINO_3rd_YEAR_DSAL01E" +
                ...
                pictureBox4.Image = pic; pictureBox5.Image = pic; pictureBox10.Image = pic;
                pictureBox9.Image = pic; pictureBox8.Image = pic; pictureBox7.Image = pic;
                pictureBox6.Image = pic; pictureBox15.Image = pic; pictureBox14.Image = pic;
                pictureBox13.Image = pic; pictureBox12.Image = pic; pictureBox11.Image = pic;
                pictureBox20.Image = pic; pictureBox19.Image = pic; pictureBox18.Image = pic;
                pictureBox17.Image = pic; pictureBox16.Image = pic;
        ...
        private void save_btn_Click(object sender, EventArgs e)
        {
            try
            {
                posdb_connect.pos_sql = "INSERT INTO pos_nameTbl " +
                        "(pos_id, name1, name2, name3, name4, name5, name6, name7," +
                        "name8, name9, name10, name11, name12, name13, name14, name15," +
                        "name16, name17, name18, name19, name20) VALUES " +
                        "('" + pos_id_comboBox.Text + "', '" +
                        nameTxtbox1.Text + "', '" + nameTxtbox2.Text + "', '" + nameTxtbox3.Text + "', '" +
                        nameTxtbox4.Text + "', '" + nameTxtbox5.Text + "', '" + nameTxtbox6.Text + "', '" +
                        nameTxtbox7.Text + "', '" + nameTxtbox8.Text + "', '" + nameTxtbox9.Text + "', '" +
                        nameTxtbox10.Text + "', '" + nameTxtbox11.Text + "', '" + nameTxtbox12.Text + "', '" +
                        nameTxtbox13.Text + "', '" + nameTxtbox14.Text + "', '" + nameTxtbox15.Text + "', '" +
                        nameTxtbox16.Text + "', '" + nameTxtbox17.Text + "', '" + nameTxtbox18.Text + "', '" +
                        nameTxtbox19.Text + "', '" + nameTxtbox20.Text + "')";
                posdb_connect.pos_cmd();
                ...
                posdb_connect.pos_sql = "INSERT INTO pos_priceTbl " +
                            ...
                            "price8, price9, price10, price11, price12, price13, price14," +
                            "price15, price16, price17, price18, price19, price20, pos_id) VALUES " +
                            "('" + priceTxtbox1.Text + "', '" + priceTxtbox2.Text + "', '" + priceTxtbox3.Text + "', '" +
                            priceTxtbox4.Text + "', '" + priceTxtbox5.Text + "', '" + priceTxtbox6.Text + "', '" +
                            priceTxtbox7.Text + "', '" + priceTxtbox8.Text + "', '" + priceTxtbox9.Text + "', '" +
                            priceTxtbox10.Text + "', '" + priceTxtbox11.Text + "', '" + priceTxtbox12.Text + "', '" +
                            priceTxtbox13.Text + "', '" + priceTxtbox14.Text + "', '" + priceTxtbox15.Text + "', '" +
                            priceTxtbox16.Text + "', '" + priceTxtbox17.Text + "', '" + priceTxtbox18.Text + "', '" +
                            priceTxtbox19.Text + "', '" + priceTxtbox20.Text + "', '" + pos_id_comboBox.Text + "')";
                posdb_connect.pos_cmd();
                posdb_connect.pos_sqladapterInsert();

                posdb_connect.pos_sql = "INSERT INTO pos_picTbl " +
                            "(pic1, pic2, pic3, pic4, pic5, pic6, pic7," +
                            "pic8, pic9, pic10, pic11, pic12, pic13, pic14," +
                            "pic15, pic16, pic17, pic18, pic19, pic20, pos_id) VALUES " +
                            "('" + picpathTxtbox1.Text + "', '" + picpathTxtbox2.Text + "', '" + picpathTxtbox3.Text + "', '" +
                            picpathTxtbox4.Text + "', '" + picpathTxtbox5.Text + "', '" + picpathTxtbox6.Text + "', '" +
                            picpathTxtbox7.Text + "', '" + picpathTxtbox8.Text + "', '" + picpathTxtbox9.Text + "', '" +
                            picpathTxtbox10.Text + "', '" + picpathTxtbox11.Text + "', '" + picpathTxtbox12.Text + "', '" +
                            picpathTxtbox13.Text + "', '" + picpathTxtbox14.Text + "', '" + picpathTxtbox15.Text + "', '" +
                            picpathTxtbox16.Text + "', '" + picpathTxtbox17.Text + "', '" + picpathTxtbox18.Text + "', '" +
                            picpathTxtbox19.Text + "', '" + picpathTxtbox20.Text + "', '" + pos_id_comboBox.Text + "')";
                posdb_connect.pos_cmd();
                posdb_connect.pos_sqladapterInsert();
                ...
                dataGridView1.DataSource = posdb_connect.pos_sql_dataset.Tables[0];
                clear_textboes();
                pos_id_comboBox.Items.Add(pos_id_comboBox.Text);
            }
            catch (Exception)
            {
                MessageBox.Show("Error occurs in this area. Please contact your administrator!");
        ...
        private void update_btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                posdb_connect.pos_sql = "UPDATE pos_nameTbl SET " +
                    "name1 = '" + nameTxtbox1.Text + "', name2 = '" + nameTxtbox2.Text + "', " +
                    "name3 = '" + nameTxtbox3.Text + "', name4 = '" + nameTxtbox4.Text + "', " +
                    "name5 = '" + nameTxtbox5.Text + "', name6 = '" + nameTxtbox6.Text + "', " +
                    "name7 = '" + nameTxtbox7.Text + "', name8 = '" + nameTxtbox8.Text + "', " +
                    "name9 = '" + nameTxtbox9.Text + "', name10 = '" + nameTxtbox10.Text + "', " +
                    "name11 = '" + nameTxtbox11.Text + "', name12 = '" + nameTxtbox12.Text + "', " +
                    "name13 = '" + nameTxtbox13.Text + "', name14 = '" + nameTxtbox14.Text + "', " +
                    "name15 = '" + nameTxtbox15.Text + "', name16 = '" + nameTxtbox16.Text + "', " +
                    "name17 = '" + nameTxtbox17.Text + "', name18 = '" + nameTxtbox18.Text + "', " +
                    "name19 = '" + nameTxtbox19.Text + "', name20 = '" + nameTxtbox20.Text + "' " +
                ...
                posdb_connect.pos_sql = "UPDATE pos_priceTbl SET " +
                    "price1 = '" + priceTxtbox1.Text + "', price2 = '" + priceTxtbox2.Text + "', " +
                    "price3 = '" + priceTxtbox3.Text + "', price4 = '" + priceTxtbox4.Text + "', " +
                    "price5 = '" + priceTxtbox5.Text + "', price6 = '" + priceTxtbox6.Text + "', " +
                    "price7 = '" + priceTxtbox7.Text + "', price8 = '" + priceTxtbox8.Text + "', " +
                    "price9 = '" + priceTxtbox9.Text + "', price10 = '" + priceTxtbox10.Text + "', " +
                    "price11 = '" + priceTxtbox11.Text + "', price12 = '" + priceTxtbox12.Text + "', " +
                    "price13 = '" + priceTxtbox13.Text + "', price14 = '" + priceTxtbox14.Text + "', " +
                    "price15 = '" + priceTxtbox15.Text + "', price16 = '" + priceTxtbox16.Text + "', " +
                    "price17 = '" + priceTxtbox17.Text + "', price18 = '" + priceTxtbox18.Text + "', " +
                    "price19 = '" + priceTxtbox19.Text + "', price20 = '" + priceTxtbox20.Text + "' " +
                    "WHERE pos_id = '" + pos_id_comboBox.Text + "'";
                posdb_connect.pos_cmd();
                posdb_connect.pos_sqladapterUpdate();
                ...
                posdb_connect.pos_sql = "UPDATE pos_picTbl SET " +
                    "pic1 = '" + picpathTxtbox1.Text + "', pic2 = '" + picpathTxtbox2.Text + "', " +
                    "pic3 = '" + picpathTxtbox3.Text + "', pic4 = '" + picpathTxtbox4.Text + "', " +
                    "pic5 = '" + picpathTxtbox5.Text + "', pic6 = '" + picpathTxtbox6.Text + "', " +
                    "pic7 = '" + picpathTxtbox7.Text + "', pic8 = '" + picpathTxtbox8.Text + "', " +
                    "pic9 = '" + picpathTxtbox9.Text + "', pic10 = '" + picpathTxtbox10.Text + "', " +
                    "pic11 = '" + picpathTxtbox11.Text + "', pic12 = '" + picpathTxtbox12.Text + "', " +
                    "pic13 = '" + picpathTxtbox13.Text + "', pic14 = '" + picpathTxtbox14.Text + "', " +
                    "pic15 = '" + picpathTxtbox15.Text + "', pic16 = '" + picpathTxtbox16.Text + "', " +
                    "pic17 = '" + picpathTxtbox17.Text + "', pic18 = '" + picpathTxtbox18.Text + "', " +
                    "pic19 = '" + picpathTxtbox19.Text + "', pic20 = '" + picpathTxtbox20.Text + "' " +
                    "WHERE pos_id = '" + pos_id_comboBox.Text + "'";
                posdb_connect.pos_cmd();
                posdb_connect.pos_sqladapterUpdate();
        ...
        private void delete_btn_Click(object sender, EventArgs e)
        {
            try
            {
                posdb_connect.pos_sql = "DELETE FROM pos_priceTbl WHERE pos_id = '" + pos_id_comboBox.Text + "'";
                posdb_connect.pos_cmd();
                posdb_connect.pos_sqladapterDelete();

                posdb_connect.pos_sql = "DELETE FROM pos_picTbl WHERE pos_id = '" + pos_id_comboBox.Text + "'";
                posdb_connect.pos_cmd();
                posdb_connect.pos_sqladapterDelete();

                posdb_connect.pos_sql = "DELETE FROM pos_nameTbl WHERE pos_id = '" + pos_id_comboBox.Text + "'";
                posdb_connect.pos_cmd();
                posdb_connect.pos_sqladapterDelete();
