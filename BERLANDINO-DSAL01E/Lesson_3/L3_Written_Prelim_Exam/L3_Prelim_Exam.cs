...
namespace BERLANDINO_DSAL01E.Exam
{
    public partial class L3_Prelim_Exam : Form
    {

        public L3_Prelim_Exam()
        {
            InitializeComponent();
        }
        ...
        {
            // disable textboxes that are not needed
        ...
        private void gross_income_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                tax_contrib = (((gross_income * 24) - 250000) * 0.15) / 24;
            }
            else if (gross_income > 16666.67 && gross_income <= 33333.33)
            {
                tax_contrib = ((((gross_income * 24) - 400000) * 0.20) + 30000) / 24;
            }
            else if (gross_income > 33333.33 && gross_income <= 83333.33)
            {
                tax_contrib = ((((gross_income * 24) - 800000) * 0.25) + 130000) / 24;
            }
            else if (gross_income > 83333.33 && gross_income <= 333333.33)
            {
                tax_contrib = ((((gross_income * 24) - 2000000) * 0.30) + 490000) / 24;
            }
            else
            {
            ...
            // formulas for calculating loans, contrib, and deduction
        ...
        {
            // call other form to print the payslip
            L3_Prelim_Exam_Prnt print = new L3_Prelim_Exam_Prnt();
        ...
        {
            // remove all user-input textboxes
