...
namespace BERLANDINO_DSAL01E
{
    public partial class L8_Activity3 : Form
    {
        ...
        private void other_convert_textboxes()
        {
        ...
        private void hono_convert_textboxes()
        {
        ...
        private void basic_convert_textboxes()
        {
        ...
        private void converting_compute_textboxes()
        {
        ...
        {
            if (other_numhrs_txtbox.Text == "") return;
            other_convert_textboxes();
        ...
        {
            if (hono_numhrs_txtbox.Text == "") return;
            hono_convert_textboxes();
        ...
        {
            if (basic_numhrs_txtbox.Text == "") return;
            basic_convert_textboxes();
